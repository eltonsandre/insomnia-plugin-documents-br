...
const NOMES_COMPOSTO_FEMININO = [
    'Maria Júlia', 'Maria Luíza', 'Maria Clara', 'Maria Eduarda', 'Maria Cecília',
    'Maria Alice', 'Ana Clara', 'Ana Luíza', 'Ana Júlia', 'Ana Laura', 'Maria Helena',
...
const NOMES_COMPOSTO_MASCULINO = [
    ...
    'Luiz Miguel', 'Marcos Vinícius', 'João Lucas', 'Luiz Guilherme',
    ...
    async run(context, isMasc, nomeParam, isNomeRandom, isNomeCompostoRandom, sobrenomeParam, isSobrenomeRandom, isSegundoSobrenome) {
        ...
        if (isNomeRandom) {
            if (isNomeCompostoRandom) {
                ...
                nome = nomes[RandomUtils.getRandomInt(0, (nomes.length - 1))];
            } else {
        ...
        if (isSobrenomeRandom) {
            sobrenome = SOBRENOMES[RandomUtils.getRandomInt(0, (SOBRENOMES.length - 1))];
        }
        if (isSegundoSobrenome) {
            sobrenome2 = ' ' + SOBRENOMES[RandomUtils.getRandomInt(0, (SOBRENOMES.length - 1))];
        }
